...
def thread_for_weather_maps(locations):
 ...
 #           folium.TileLayer('cartodbpositron').add_to(maps)
            ...
            maps.save("C://Users//Brijesh//Documents//forecast//"+city+"_"+last_timestamp_date.replace(":","_")+".html")
...
#        folium.TileLayer('cartodbdark_matter').add_to(maps)
        ...
        legend_html =   '''
                ...
                ''' %(icon_url,weather)
        maps.get_root().html.add_child(folium.Element(legend_html))        
        maps.save("C://Users//Brijesh//Documents//forecast//"+city+"_"+last_timestamp_date.replace(":","_")+"_latest_weather.html")
...
def thread_for_plotting_forecast_data():
    ...
    for city in city_names:
        ...
        plt.savefig("C://Users//Brijesh//Desktop//"+city+".png")
        plt.close()
